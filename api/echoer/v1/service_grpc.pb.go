...
const (
	Service_Echo_FullMethodName = "/echoer.v1.Service/Echo"
)
...
func (c *serviceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Service_Echo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "echoer/v1/service.proto",
}
